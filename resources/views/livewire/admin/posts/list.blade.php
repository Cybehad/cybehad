...
<div>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Admin / Blog Posts</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($posts as $post)
                <div class="rounded-lg shadow-md overflow-hidden bg-gray-100 dark:bg-gray-800">
                    @if($post->image)
                        <img src="{{  $post->image }}" alt="{{ Str::limit($post->title, limit: 80, end: '...') }}"
                    ...
                    <div class="p-6">
                        ...
                        <h2 class="text-xl font-bold mb-2">
                            <a href="{{ route('admin.posts.show', $post->id) }}" wire::navigate
                                class="hover:text-blue-600">{{ Str::limit($post->title, 20) }}</a>
                        </h2>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="mt-6 flex space-x-4">
                                <a href="{{ route('admin.posts.edit', $post->id) }}" wire:navigate
                                    class="bg-blue-600 text-white px-2 rounded hover:bg-blue-700">Edit</a>
                                <a href="{{ route('admin.posts.show', $post->id) }}" wire:navigate
                                    class="bg-gray-600 text-white px-2 rounded hover:bg-gray-700">Show</a>
                            </div>
